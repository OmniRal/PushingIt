...
local function SetupSettings()
	...
	DragSlider.Set(MusicVolumeSlider, function() 
		DataService:RequestChangeSetting("MusicVolume", MusicVolumeSlider:GetAttribute("CurrentVal"))
		SoundService.Music.Volume = MusicVolumeSlider:GetAttribute("CurrentVal")
	end, NumberRange.new(0, 1), 10, 1)

	DragSlider.Set(VoiceoversVolumeSlider, function() 
		DataService:RequestChangeSetting("VoiceoversVolume", VoiceoversVolumeSlider:GetAttribute("CurrentVal"))
		SoundService.Voiceovers.Volume = VoiceoversVolumeSlider:GetAttribute("CurrentVal")
	end, NumberRange.new(0, 1), 10, 1)

	DragSlider.Set(SoundFXVolumeSlider, function() 
		DataService:RequestChangeSetting("SoundFXVolume", SoundFXVolumeSlider:GetAttribute("CurrentVal"))
		SoundService.SoundFX.Volume = SoundFXVolumeSlider:GetAttribute("CurrentVal")
	end, NumberRange.new(0, 1), 10, 1)
